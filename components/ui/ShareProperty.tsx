...
import { Share2, X, Facebook, Twitter, Linkedin, Mail, Link2, Check } from 'lucide-react'
...
export function ShareProperty({ propertyTitle, propertyUrl, className = '' }: SharePropertyProps) {
